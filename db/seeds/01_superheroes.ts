...
const superHeroesData = [
  ...
  },
  {
    ...
    poder:
      'Fuerza, agilidad y reflejos sobrehumanos gracias al suero del supersoldado',
  ...
  },
  {
    ...
    debilidad:
      'Sus manos dañadas limitan sus gestos mágicos si no usa el artefacto',
...
export async function seed(knex: Knex): Promise<void> {
  ...
  console.log(
    ` ${superHeroesData.length} Superhéroes insertados en la tabla '${TABLE_NAME}'.`
  );
}
